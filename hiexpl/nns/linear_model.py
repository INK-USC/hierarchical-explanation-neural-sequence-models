        ...
        for batch_idx, batch in enumerate(train_iter):
            ...
            if iterations % args.dev_every == 0:
                ...
                if args.task in ['sst', 'yelp']:
                    dev_acc = 100. * accuracy_score(truth_dev, pred_dev)
                elif args.task == 'tacred':
                    dev_acc = 100. * f1_score(truth_dev, pred_dev)[-1]
                else:
                    raise ValueError
...
if __name__ == '__main__':
    if args.task == 'sst':
        ...
        inputs, labels, train_iter, dev_iter, test_iter, train_set, dev_set = get_data_iterators_yelp()
    elif args.task == 'tacred':
        inputs, labels, subj_offset, obj_offset, pos, ner, train_iter, dev_iter, test_iter, train_set, dev_set = \
