...
if __name__ == '__main__':
    if args.task == 'sst':
        inputs, lengths, train_iter, dev_iter, test_iter, train_set, dev_set = get_data_iterators_sst_flatten(train_lm=True)
    elif args.task == 'yelp':
        inputs, labels, train_iter, dev_iter, test_iter, train_set, dev_set = get_data_iterators_yelp(
            train_lm=True)
    elif args.task == 'tacred':
        inputs, labels, subj_offset, obj_offset, pos, ner, train_iter, dev_iter, test_iter, train_set, dev_set = get_data_iterators_tacred(train_lm=True)
    else:
